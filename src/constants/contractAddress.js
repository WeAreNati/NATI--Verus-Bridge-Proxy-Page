...
export const GLOBAL_ADDRESS = TESTNET ? { // vrsctest hex 'id' names of currencies must be checksummed i.e. mixture of capitals
  ...
  NATIVETH: "0x000000000000000000000000000000000000000",
  NATI: "0x0000000000000000000000000000000000000000"
  // VARRR: process.env.REACT_APP_VARRR_TESTNET_CONTRACT,
  // MARRR: process.env.REACT_APP_MARRR_TESTNET_CONTRACT
} : {
  ...
  NATIVETH: "0x0000000000000000000000000000000000000000",
  NATI: "0x0000000000000000000000000000000000000000"
}
...
export const GLOBAL_IADDRESS = TESTNET ? { // vrsctest hex 'id' names of currencies must be checksummed i.e. mixture of capitals
  ...
  VARRR: process.env.REACT_APP_VARRR_TESTNET_CONTRACT,
  MARRR: process.env.REACT_APP_MARRR_TESTNET_CONTRACT,
  NATIVETH: "iN9vbHXexEh6GTZ45fRoJGKTQThfbgUwMh",
  NATI: "iN9vbHXexEh6GTZ45fRoJGKTQThfbgUwMh"
} : {
